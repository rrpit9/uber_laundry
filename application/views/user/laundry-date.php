							...
							<div class="col-lg-12">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<?=form_open_multipart('user/add_laundry_date',['class'=>'form-horizontal']); ?>
										...
										<?php if($data) { $i=1;
											foreach ($data->result_array() as $key => $value)
											{
												...
												<tr class="<?=($value['status']==1)?"bg-success":"bg-danger";?>">
													...
													<td>
														<div class="btn-group">														
															<a class="btn btn-sm btn-info" href="<?=base_url('user/edit_date/'.$value['id'].'');?>"> Edit </a>

															<?php if($value['status']==1)
															{ ?>
																<a href="<?=base_url('user/date_status/'.$value['id'].'/0');?>"  class="btn btn-sm btn-warning">De-Activate</a> <?php
															}else
															{ ?>
																<a href="<?=base_url('user/date_status/'.$value['id'].'/1');?>" class="btn btn-sm btn-primary">Activate</a>
															<?php } ?>

															<a class="btn btn-sm btn-success" href="<?=base_url('user/add_time_slot/'.$value['id'].'');?>"> Add Time Slot </a>
														</div>
													</td>
												</tr>
												<?php $i++;  } } else { ?>
