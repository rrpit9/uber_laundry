					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<?=form_open_multipart('user/add_new_banner',['class'=>'form-horizontal']); ?>
									...
									<tbody>
										<?php if($data) { $i=1;
											...
											<tr class="bg-success">
												...
												<td>
													<div class="btn-group">														
														<a class="btn btn-sm btn-info" href="<?=base_url('user/edit_banner/'.$value['id'].'');?>"> Edit </a>

														<a href="<?=base_url('user/banner_delete/'.$value['id'].'');?>" class="btn btn-sm btn-success">Delete Banner</a>
													</div>
												</td>
											</tr>
											<?php $i++;  } } else { ?>
