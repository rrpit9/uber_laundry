			...
			<div class="container-fluid">
				...
				<div class="row padding-top">
					...
					<div class="col-lg-10 col-lg-offset-1">
						<?= form_open('user/all_booking',['class'=>'form-horizontal','autocomplete'=>'off']); ?>
											...
											<tr class="<?=($value['booking_status']==9)?"bg-danger":"bg-success";?>">
												...
												<td>
													<div class="btn-group">
														...
														<a class="btn btn-sm btn-info" href="<?=base_url('user/booking_details/'.$value['id'].'');?>" target="_blank"> Details </a>													
