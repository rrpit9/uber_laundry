						...
						<div class="col-lg-12">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<?=form_open_multipart('auth/add_new_product',['class'=>'form-horizontal']); ?>
										...
										<?php if($products) { $i=1;
											foreach ($products->result_array() as $key => $value)
											{
												...
												<tr class="<?=($value['status']==1)?"bg-success":"bg-danger";?>">
													...
													<td>
														<div class="btn-group">														
															<a class="btn btn-sm btn-info" href="<?=base_url('auth/product_edit/'.$value['id'].'');?>"> Edit </a>													
															
															<?php if($value['status']==1)
															{ ?>
																<a href="<?=base_url('auth/product_status/'.$value['id'].'/0');?>" class="btn btn-sm btn-warning">De-Activate</a> <?php
															}else
															{ ?>
																<a href="<?=base_url('auth/product_status/'.$value['id'].'/1');?>" class="btn btn-sm btn-primary">Activate</a>
															<?php } ?>
															<a class="btn btn-sm btn-danger" href="<?=base_url('auth/delete_product/'.$value['id'].'');?>"> Delete </a>
														</div>
													</td>
												</tr>
												<?php $i++;  } } else { ?>
