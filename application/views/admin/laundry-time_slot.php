	...
	<body>
		...
		<div class="wrapper" id="wrapper">
			...
			$page['link_page']= [
				...
				"Dashboard"=>base_url()."auth/laundry_dashboard/".$laundry->id,
				"Date"=>base_url()."auth/laundry_date/".$laundry->id
			];
			?>
							...
							<div class="col-lg-12">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<?=form_open_multipart('auth/insert_time_slot',['class'=>'form-horizontal']); ?>
												...
												<tr class="bg-success">
													...
													<td>
														<div class="btn-group">														
															...
															<a class="btn btn-sm btn-danger" href="<?=base_url('auth/delete_time_slot/'.$value['id'].'');?>"> Delete Time Slot </a>
														</div>
													</td>
												</tr>
											<?php $i++;  } } else { ?>
