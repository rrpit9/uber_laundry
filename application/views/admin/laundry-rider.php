									...
									<tbody>
										<?php if($data) { $i=1;
											...
											<tr class="bg-success">
												...
												<td>
													<div class="btn-group">														
														<a class="btn btn-sm btn-info" href="<?=base_url('auth/rider_edit/'.$value['id'].'');?>"> Edit </a>

														<a href="<?=base_url('auth/rider_delete/'.$value['id'].'');?>" class="btn btn-sm btn-success">Delete Rider</a>
													</div>
												</td>
											</tr>
											<?php $i++;  } } else { ?>
