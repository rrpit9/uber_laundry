...
<html lang="en">
<head>
	<title><?=$page['page']='Add Category';?> | <?=SITE_TITLE;?></title>
					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								...
								<span class="panel-title"><i class="fa fa-list"></i>Add New Category</span>
								
							</div>
							<div class="panel-body">
								<?=form_open_multipart('auth/add_new_category',['class'=>'form-horizontal']); ?>
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<input type="text" value="" name="category_name" class="form-control date" id="" placeholder="Category Name" required>
									</div>
